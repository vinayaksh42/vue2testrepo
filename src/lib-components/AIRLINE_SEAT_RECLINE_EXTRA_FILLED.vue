  ...
  export default /*#__PURE__*/Vue.extend({
    name: 'EOS_AIRLINE_SEAT_RECLINE_EXTRA_FILLED', // vue component name
    props:  {
        size: {
          type: String,
          required: false,
