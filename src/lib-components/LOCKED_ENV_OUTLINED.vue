  ...
  export default /*#__PURE__*/Vue.extend({
    name: 'EOS_LOCKED_ENV_OUTLINED', // vue component name
    props:  {
        size: {
          type: String,
          required: false,
  ...
  <template>
      <svg v-bind:transform="transform(deg,horizontalFlip,verticalFlip)" v-bind:fill="color" v-bind:width="sizeFunction(size)" v-bind:height="sizeFunction(size)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><polygon points="7.829 14.59 7.829 15.342 6.524 15.342 6.524 16.219 8 16.219 8 17 5.55 17 5.55 13 8 13 8 13.781 6.524 13.781 6.524 14.59 7.829 14.59"/><path d="M17,8H16V6A5,5,0,0,0,6,6V8H5a2.00587,2.00587,0,0,0-2,2V20a2.00591,2.00591,0,0,0,2,2H17a2.00591,2.00591,0,0,0,2-2V10A2.00587,2.00587,0,0,0,17,8ZM7.9,6a3.1,3.1,0,1,1,6.2,0V8H7.9ZM17,20H5V10H17Z"/><polygon points="12.168 17 11.194 17 9.564 14.533 9.564 17 8.59 17 8.59 13 9.564 13 11.194 15.479 11.194 13 12.168 13 12.168 17"/><polygon points="15.101 17 13.899 17 12.5 13 13.5 13 14.5 16 15.5 13 16.5 13 15.101 17"/></svg>
  </template>
