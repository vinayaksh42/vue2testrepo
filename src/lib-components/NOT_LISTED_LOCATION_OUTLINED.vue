  ...
  export default /*#__PURE__*/Vue.extend({
    name: 'EOS_NOT_LISTED_LOCATION_OUTLINED', // vue component name
    props:  {
        size: {
          type: String,
          required: false,
