  ...
  export default /*#__PURE__*/Vue.extend({
    name: 'EOS_VIRTUAL_SPACE_FILLED', // vue component name
    props:  {
        size: {
          type: String,
          required: false,
  ...
  <template>
      <svg v-bind:transform="transform(deg,horizontalFlip,verticalFlip)" v-bind:fill="color" v-bind:width="sizeFunction(size)" v-bind:height="sizeFunction(size)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z"/><circle cx="11.99866" cy="7.49265" r="1.49264"/><circle cx="11.99866" cy="16.49265" r="1.49264"/><circle cx="16.49592" cy="12" r="1.49264"/><circle cx="7.49592" cy="12" r="1.49264"/><circle cx="11.99866" cy="12" r="1"/></svg>
  </template>
