  ...
  export default /*#__PURE__*/Vue.extend({
    name: 'EOS_PATCH_FIXES_OUTLINED', // vue component name
    props:  {
        size: {
          type: String,
          required: false,
