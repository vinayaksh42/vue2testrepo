  ...
  export default /*#__PURE__*/Vue.extend({
    name: 'EOS_APP_SETTINGS_ALT_OUTLINED', // vue component name
    props:  {
        size: {
          type: String,
          required: false,
