  ...
  <template>
      <svg v-bind:transform="transform(deg,horizontalFlip,verticalFlip)" v-bind:fill="color" v-bind:width="sizeFunction(size)" v-bind:height="sizeFunction(size)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><polygon points="16 17 13 17 13 13 11 13 11 17 8 17 8 18 2 18 2 20 8 20 8 21 16 21 16 20 22 20 22 18 16 18 16 17"/><path d="M15,13h3a1,1,0,0,0,1-1V5a1,1,0,0,0-1-1H12L11,3H6A1,1,0,0,0,5,4v8a1,1,0,0,0,1,1h9Z"/></svg> 
  </template>
